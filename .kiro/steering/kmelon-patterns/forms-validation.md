...
## Etapa 7 (UI) — Sem Controller

Na etapa 7, o form é 100% visual com validadores inline e comentários `// TODO: [etapa 8]`:
      ...
      child: Column(
        children: [
          ...
          TextFormField(
            ...
            validator: (value) {
              // TODO: [etapa 8] mover para controller.validatePassword()
...
## Etapa 8 (Lógica) — Com Controller

Na etapa 8, conecta com controller, adiciona `Get.find()` e `Obx()`:
