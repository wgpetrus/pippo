...
- [x] 1. Add google_sign_in dependency
  - Add `google_sign_in: ^6.2.1` to pubspec.yaml
  - Run `flutter pub get`
  - _Requirements: 1.1_

- [x] 2. Implement signInWithGoogle method in AuthController
  - [x] 2.1 Add Google Sign-In instance and method signature
  ...
  - [x] 2.2 Implement Google authentication flow
  ...
  - [x] 2.3 Implement user document handling
  ...
  - [x] 2.4 Implement navigation logic
...
- [x] 3. Implement error handling
  ...
  - [x] 3.2 Write property test for error message security
    - **Property 4: Error Message Security**
    - **Validates: Requirements 2.9, 5.6**

- [x] 4. Implement Facebook placeholder
  - Add onFacebookTap() method
  - Show SnackBar with "Login com Facebook estará disponível em breve!"
  - _Requirements: 3.1, 3.2, 3.3, 3.4_

- [x] 5. Connect SigninView to controller
  - [x] 5.1 Connect Google button to signInWithGoogle
    - Disable when isLoading is true
    - _Requirements: 1.1, 4.2_
  
  - [x] 5.2 Connect Facebook button to onFacebookTap
    - Disable when isLoading is true
    - _Requirements: 3.1, 4.2_
  
  - [x] 5.3 Ensure all buttons disabled during loading
    - Email login button
    - Google button
    - Facebook button
...
- [x] 6. Write property test for loading state consistency
